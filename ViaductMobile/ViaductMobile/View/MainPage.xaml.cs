...
namespace ViaductMobile
{
    ...
    public partial class MainPage : ContentPage
    {
        ...
        public MainPage(User loggedUser)
        {
            ...
            {
                ToolbarItem employeesPanel = new ToolbarItem() { Text = "Pracownicy", Order = ToolbarItemOrder.Primary, Priority = 0 };
            ...
            {
                ToolbarItem deliveryCart = new ToolbarItem() { Text = "Dostawy", Order = ToolbarItemOrder.Primary, Priority = 0};
                ToolbarItem adressesPanel = new ToolbarItem() { Text = "Adresy", Order = ToolbarItemOrder.Primary, Priority = 0 };
                ToolbarItem pizzasPanel = new ToolbarItem() { Text = "Produkty", Order = ToolbarItemOrder.Primary, Priority = 0 };
            ...
            ToolbarItem userPanel = new ToolbarItem() { Text = "Panel", Order = ToolbarItemOrder.Primary, Priority = 0 };
            userPanel.Clicked += MoveToUserPanelClicked;
            this.ToolbarItems.Add(userPanel);
            ToolbarItem logout = new ToolbarItem() { Text = "Wyloguj", Order = ToolbarItemOrder.Primary, Priority = 0 };
